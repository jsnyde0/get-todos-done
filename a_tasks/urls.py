...
urlpatterns = [
    ...
    path('filter/', views.list_view, name='view_filter'),
    ...
    path('task/<str:id>/delete/', views.delete_task, name='delete_task'),
    path('subtask/<str:id>/update/', views.update_subtask_title, name='update_subtask_title'),
]